"""
Calculation and selection of the smallest standard or user defined cross section for a wooden beam that can support the given load during a parametric fire using the strength reduction method
